...
import dagshub
dagshub.init(repo_owner='varshith-mohan', repo_name='MLFLOW', mlflow=True)

mlflow.set_tracking_uri("https://dagshub.com/varshith-mohan/MLFLOW.mlflow")
...
max_depth = 15    #t otal number of decision trees in the ensemble model.
n_estimators = 10  # Controls the maximum number of levels (splits) a single decision tree is allowed to grow
...
mlflow.set_experiment('MLOPS-exp-2-mlflow-dagshub')
